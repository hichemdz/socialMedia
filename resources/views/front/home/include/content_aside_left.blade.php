<aside class="fixed w-1/5" >
        <ul>
            @auth
                <li class ='mb-2 py-2 hover:bg-gray-700  rounded-md'>
                    <a href="/profile/{{Auth::user()->id}}" class="flex px-3 text-gray-300 font-semibold items-center">
                        @php
                            $src = pict();
                        @endphp
                        <img class='rounded-full w-6 h-6  mr-3' src="{{asset('/storage/front/profile/'.$src)}}" alt="">
                        {{Auth::user()->name}}
            ...
            <li class ='mb-2 py-2 hover:bg-gray-700  rounded-md'>
                <a href="/profile/{{Auth::user()->id}}" class="flex px-3 text-gray-300 font-semibold items-center">
                    <svg class="w-6 h-6 mr-3 fill-current text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <defs/>
                        <path fill="none" d="M0 0h24v24H0z"/>
                        <path d="M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z"/>
                    </svg>
                    <span class='text-gray-300 font-semibold '>{{ucfirst(__('home.pages')) }}</span>
                </a>
            </li>
            ...
            <li class ='mb-2 py-2 hover:bg-gray-700  rounded-md'>
                <a href="/profile/{{Auth::user()->id}}" class="flex px-3 text-gray-300 font-semibold items-center">
                    <svg class="w-6 h-6 mr-3 fill-current text-gray-300 rounded-full p-1  bg-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <defs/>
                        <path fill="none" d="M0 0h24v24H0z"/>
            ...
            <li class ='mb-2 py-2 hover:bg-gray-700  rounded-md'>
                <a href="/profile/{{Auth::user()->id}}" class="flex px-3 text-gray-300 font-semibold items-center">
                    ...
                    <span class='text-gray-300 font-semibold'>Covid-19 Information Center</span>
                </a>
            </li>
            ...
            <li class ='py-2 hover:bg-gray-700  rounded-md'>
                <a href="/profile/{{Auth::user()->id}}" class="flex px-3 text-gray-300 font-semibold items-center">
                    <svg class="w-6 h-6 mr-3 fill-current text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <defs/>
