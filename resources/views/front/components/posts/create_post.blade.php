<div class=" px-3 py-2 rounded-lg bg-gray-800 max-h-36 items-center ">
    <div class="flex py-3 ">
    ...
    <div class="flex  text-sm sm:text-md justify-around">
        <button class=" flex flex-col sm:flex-row items-center  hover:bg-gray-600 px-2 py-1 rounded">
