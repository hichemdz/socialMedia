<header>
    <nav class="bg-gray-900 text-white">
        <div class="container py-2 flex m-auto items-center justify-between ">
            <div class="flex w-1/2">
                <a href="/" class='mr-2'>
                    <svg viewBox="0 0 36 36" class="w-8" fill="url(#jsc_s_4)" height="40" width="40"><defs><linearGradient x1="50%" x2="50%" y1="97.0782153%" y2="0%" id="jsc_s_4"><stop offset="0%" stop-color="#0062E0"></stop><stop offset="100%" stop-color="#19AFFF"></stop></linearGradient></defs>
            ...
            <ul class="flex justify-between  items-center w-1/2">
                @auth
                <li class='mx-2 bg-gray-800 py-1 px-3 rounded-full'>
                    <a href="profile/{{Auth::user()->id}}" class="flex items-center">
                     <img class='rounded-full w-8  mr-2' src="{{asset('img/profile/pr.jpg')}}" alt="">   
                     {{Auth::user()->name}}
                    </a>
                </li>
                ...
                <li class='mx-2' ><a href="">
                    <svg viewBox="0 0 28 28" class="w-5 fill-current text-gray-200" height="28" width="28">
