...
@section('main')
   <main class="grid grid-cols-12">
    ...
    <div class="relative  bg-red-200
      ...
      <div class=" w-24 h-24 z-10 m-auto relative"
          id="photo_profile"
  ...
  <div id='file_editor' class="fixed flex justify-center  hidden
    ...
    <form class='flex w-64 h-64 flex-col p-3' action="/profile" method='POST' enctype="multipart/form-data" >
      @csrf
      <input class="mb-2 p-2 rounded-full bg-gray-300" type="hidden" id="profile_id" name='profile_id'  value='{{$profile->id}}'>
      <input class="mb-2 p-2 bg-gray-300 rounded-full" id='type' type="hidden" name='type'>

      <input type="file" class="bg-gray-300 p-2 mb-2 rounded-full" name="path" id="file">
      <button class="bg-blue-500 p-3 rounded-full " type="submit" id="submitData">upload</button>
  </form>
